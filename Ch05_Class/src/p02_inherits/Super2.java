...
/*
 * 상송박은 자식의 클래스에서 기본생성자가 아닌 다른 생성자를 이용하여 
 * 자식을 생성하려할때
...
class C2 extends C1{
	//생성자
	C2(){
		//super() : 부모생성자 호풀 메소드는 항상 자식생성자의
		//			실행블럭{}의 첫줄에 기술해야함.
		super("부모생성자 호출");	//new C1("부모생성자호출"){}
