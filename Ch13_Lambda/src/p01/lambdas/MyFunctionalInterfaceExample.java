...
public class MyFunctionalInterfaceExample {
	...
	public static void main(String[] args) {
		...
		//익구현체 생성 (이 자체가 implements) =$1.침ㄴㄴ
		...
		//람다식 표현
		//람다식은 메소드명이 없고,매개변수의 갯수가 중요
		
		fi = ()->{String str = "method call1";//명령문 1
					System.out.println(str);};//매개변수없는 람다식 //명령문2							//명령문2
		fi.method();
		
		//{}안에 명령문이 하나면 {}생략가능
		fi =()->{System.out.println("method call1");};		//명령문1
		fi.method();
